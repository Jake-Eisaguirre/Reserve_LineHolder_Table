...
q_master_history <- paste0("SELECT * FROM CT_MASTER_HISTORY WHERE PAIRING_DATE >= '2023-01-01';")
...
res_utl_q <- paste("select * from AA_RESERVE_UTILIZATION WHERE PAIRING_DATE >= '2023-01-01';")
